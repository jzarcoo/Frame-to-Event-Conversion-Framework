...
\begin{frame}{Object Detection}
  ...
  \begin{columns}[T]
    ...
    \begin{block}{DSEC Events (mAP: 0.18)}

      \begin{figure}[h]
        \centering
        \includegraphics[width=\linewidth]{figures/object_detection/dsec/img/frame_001.png}
      \end{figure}
    ...
    \begin{block}{Synthetic Events (mAP: 0.00)}
...
\begin{frame}{Bibliography}
  ...
  \bibitem{v2e} Delbruck, T., Hu, Y., \& Liu, S. (2021). \textit{v2e: From Video Frames to Realistic DVS Events}. Institute of Neuroinformatics, University of Zürich and ETH Zürich, Switzerland.
